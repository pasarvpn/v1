...
TIMES="10"
CHATID="19622851"
KEY="6866097221:AAFdDsbTF-R7_d07ewI3z0Bd7yQNhhA"
...
clear;clear;clear
echo -e " ${CYAN} ┌─────────────────────────────────────────────────┐${NC}"
echo -e " ${CYAN} │ ${BG_RED}            PASAR TUNNELING                    ${NC} ${CYAN}│$NC"
echo -e " ${CYAN} └─────────────────────────────────────────────────┘${NC}"
echo ""
...
echo -e "\e[38;5;82mloading ya ...\e[0m"
sleep 4
clear
MYIP=$(curl -sS ipv4.icanhazip.com)
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/pasarvpn/permission/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/pasarvpn/permission/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/pasarvpn/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/pasarvpn/v1/main/"
start=$(date +%s)
secs_to_human() {
...
wget raw.githubusercontent.com/pasarvpn/v1/main/limit.sh && chmod +x limit.sh && ./limit.sh
cd
